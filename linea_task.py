...
class Linea:
    ...
    async def laurent_bellue_quest(self):
        await self.phosphor.purchase_intents('86a8741b-28dd-42ca-9f2f-dfb173a62099')
        logger.success(f"account {self.idx} complete 【W4:Adélaïde Laurent-Bellue】success ✅")
...
async def start_linea_l3_quest(semaphore, mission_type, idx, private_key, proxy):
    async with semaphore:
        ...
        try:
            ...
            elif int(mission_type) == 20:
                await linea.laurent_bellue_quest()
